...
# This is a subset of "provision_all.sh" in this directory, simply create a
# CosmosDB/SQL, Synapse, Synapse Spark Pool
# (No IoT Hub and devices, Stream Analytics, SQL Pool)
#
